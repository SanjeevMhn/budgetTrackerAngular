...
import { DataSettings } from '../dialog/data-settings/data-settings';
...
export class Profile {
  ...
  openDialog(dialog: 'profile-details' | 'data-setting') {
    if (dialog == 'profile-details') {
    ...
    if (dialog == 'data-setting') {
      this.dialog.open(DataSettings, {
        width: '100vw',
        height: '100vh',
        panelClass: 'transaction-dialog',
      });
